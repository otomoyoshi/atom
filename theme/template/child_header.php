<div class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    ...
    <div class="navbar-collapse collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a id="sign_up_head" href="sign_up.php" class="header">新規登録</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a id="sign_in_head" href="sign_in.php" class="header">ログイン</a></li>
      </ul>
<!--       <ul class="nav navbar-nav navbar-right">
        <li><a id="lists_head" href="../lists.php" class="header">リスト作成</a></li>
      </ul> -->
      <ul class="nav navbar-nav navbar-right">
