...
<div class="row">
    <div class="col-xs-10 col-sm-8 col-md-8 col-xs-offset-1 col-sm-offset-2 col-md-offset-2 main_div" style="padding:0px 60px 30px 60px; margin-bottom: 15px;/* background-color: rgba(255,255,255,0.6)*/;
    ">
